...
### From the Navbar (admins only)

Click on your name in the top right corner, then click 'Add new user'


### When adding a new action

When [adding an action](add-action) you can create a new user to assign the action to
