...
1. Intervention / initiative information
   ...
   details can be added in the description
    ...
    - Budget - the amount allocated for the intervention
    - Currently spent - How much of this allocated amount has been spent so far

2. Financiers for the intervention / initiative
    - Financier name - the name of the financier
...
Any intervention targets within the same priority area that are given the same unit
(e.g. number of villages supplied with grid electricity) will automatically be aggregated
on the Priority area page and a summary graph will be shown with overall progress
...
To view the milestones planning form, click the blue arrow link in the top right
corner of the previous form.
