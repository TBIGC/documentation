...
Read our [standard contract for data security](assets/data-contract.pdf)
...
In order to guarantee that the dashboard is secure, it has been penetration tested by a software
security consultants. During this testing, the consultants were not able to access without a
dashboard login. When given a login, the consultants were unable to access data from other areas of the same
dashboard, nor access any data from other dashboards hosted on the same database
