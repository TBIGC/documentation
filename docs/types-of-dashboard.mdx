...
#### Admin restricted full project dashboard

With an admin restricted dashboard, only the admin user can approve task updates, grant deadline extensions
, add updates to target etc. This is different from the [standard model](dashboard-roles) which grants different
levels of permission based on a user's role within the dashboard
